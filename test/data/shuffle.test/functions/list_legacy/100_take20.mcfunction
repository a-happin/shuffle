#> shuffle.test:list_legacy/100_take20
#@within function shuffle.test:

data modify storage : _ append value {random: [I; 0, 3]}
  data modify storage : _[-1].name set value "shuffle.test:list_legacy/100_take20"
  ...
  data modify storage : _[-1].expected set value [3,93,73,65,57,39,92,86,26,71,85,44,61,12,97,94,52,63,76,96]
