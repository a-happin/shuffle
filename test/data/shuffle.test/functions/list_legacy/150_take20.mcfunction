#> shuffle.test:list_legacy/150_take20
#@within function shuffle.test:

data modify storage : _ append value {random: [I; 0, 3]}
  data modify storage : _[-1].name set value "shuffle.test:list_legacy/150_take20"
  ...
  data modify storage : _[-1].expected set value [3,43,82,23,55,143,52,89,27,48,41,87,37,77,84,80,142,88,5,17]
