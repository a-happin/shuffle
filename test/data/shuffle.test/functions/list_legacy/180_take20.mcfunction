#> shuffle.test:list_legacy/180_take20
#@within function shuffle.test:

data modify storage : _ append value {random: [I; 0, 3]}
  data modify storage : _[-1].name set value "shuffle.test:list_legacy/180_take20"
  ...
  data modify storage : _[-1].expected set value [3,159,97,68,74,29,163,151,6,125,31,174,171,142,65,139,43,20,52,160]
