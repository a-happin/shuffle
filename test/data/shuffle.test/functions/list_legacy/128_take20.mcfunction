#> shuffle.test:list_legacy/128_take20
#@within function shuffle.test:

data modify storage : _ append value {random: [I; 0, 3]}
  data modify storage : _[-1].name set value "shuffle.test:list_legacy/128_take20"
  ...
  data modify storage : _[-1].expected set value [3,103,101,14,42,23,51,43,50,102,75,109,13,53,113,105,85,25,81,67]
