#> shuffle.test:list_legacy/64_take20
#@within function shuffle.test:

data modify storage : _ append value {random: [I; 0, 3]}
  data modify storage : _[-1].name set value "shuffle.test:list_legacy/64_take20"
  ...
  data modify storage : _[-1].expected set value [3,21,11,54,9,42,46,0,43,55,29,13,45,63,27,56,16,24,48,47]
