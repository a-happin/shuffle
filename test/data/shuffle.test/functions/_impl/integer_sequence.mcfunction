#> shuffle.test:_impl/integer_sequence
#@within function shuffle.test:integer_sequence/**
#@input storage : _[-1].name test name
#@input storage : _[-1].begin int
#@input storage : _[-1].end int
...
data modify storage : _ append value {}
  ...
  data modify storage : _[-1].begin set from storage : _[-2].begin
